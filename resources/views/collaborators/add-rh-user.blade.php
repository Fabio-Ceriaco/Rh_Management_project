        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <h3>New Human Resources Collaborators</h3>

                    <hr>

                    <form action="{{ route('rhcollaborators.create-collaborator')}}" method="post">
                        ...
                        <div class="mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="{{ route('new.department')}}" class="btn btn-outline-primary mt-4"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="submit" class="btn btn-primary" value="Create colaborator">
                        </div>
